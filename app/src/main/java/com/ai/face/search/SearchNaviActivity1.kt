 ...
 *
 */
class SearchNaviActivity1 : AppCompatActivity(), PermissionCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.zhuti.visibility = View.GONE


        binding.aboutus.textSize = 35.0F
        binding.mima.textSize = 35.0F
        binding.showImg.textSize = 35.0F
        binding.changeCamera.textSize = 35.0F
        binding.faceSearchMn.textSize = 35.0F
        binding.faceSearch1n.textSize = 35.0F
        binding.clearMsg.textSize = 35.0F
        binding.faceSearch1n.height = 100
        binding.faceSearch1n.top = 30
        binding.mima.visibility = View.GONE
        binding.showImg.visibility = View.GONE
        binding.aboutus.setOnClickListener {
            startActivity(
                Intent(this@SearchNaviActivity1, com.ai.face.ui.about::class.java)
            )
        }

        binding.faceSearch1n.setOnClickListener {
            startActivity(
                Intent(this@SearchNaviActivity1, FaceSearch1NActivity::class.java)
            )
        }
        ...
        binding.faceSearchMn.setOnClickListener {
            startActivity(
                Intent(this@SearchNaviActivity1, FaceSearchMNActivity::class.java)
            )
        }


        //验证复制图片
        // binding.copyFaceImages.visibility = View.GONE;
        ...
        binding.editFaceImage.visibility = View.GONE;


        binding.addFaceImage.visibility = View.GONE;
...
//        binding.deviceInfo.text="设备指纹:"+ DeviceFingerprint.getDeviceFingerprint()
    ...
    companion object {
        ...
        /**
         * 拷贝工程Assets 目录下的人脸图来演示人脸搜索，实际上业务人脸可能是在局域网服务器或只能本地录入
         *
